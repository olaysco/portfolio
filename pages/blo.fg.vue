<template>
  <div class="container mt-4 position-relative">
    ...
    <div class="row">
      <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-xl-4 mb-4" v-for="i in [1,2,3]" :key="i">
        <article>
          ...
          <div class="post-text">
            <div class="post-header">
              ...
              <div class="post-meta">
                <span class="post-meta-cat d-none">
...
article {
  box-shadow: 12px 12px 40px rgba(119, 127, 136, 0.25);
}
