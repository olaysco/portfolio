          ...
          <div  data-filter-list="chat-module-body" class="chat-module">
            <div  class="chat-module-bottom">
              <h4  class="m-auto text-center pb-2 contact-head">
                  Contact me <i  class="fa fa-comments emoji"></i>
              </h4>
              <div class="mb-2">
                <span class="font-light mr-1"><i class="fas fa-envelope mr-1"></i>olayiwolaodunsi@gmai.com</span>
                <br>
                <span class="font-light"> <i class="fas fa-phone mr-1"></i>+2348113376030</span>
              </div>
              <form  class="chat-form" name="contact-me"
                    method="post"
                    @submit.prevent="sendContact()"
                    data-netlify="true"
                    data-netlify-honeypot="bot-field" netlify>
                    <input type="hidden" name="form-name" value="contact-me" />
                <div  class="chat-form-buttons-left position-absolute">
                </div>
                <textarea v-model="form.message"  placeholder="Type message" rows="3" class="form-control" ></textarea>
